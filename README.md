...
To make it simple the Angular app is built into public resources of the boot application.

The database is generated by liquibase migrations, and separate database for integration tests is used. 
 
The application is not secured as it's not supported by the client app so the user adding expenses is hard coded to userId=1.
 
Basic health monitoring is exposed and can be seen at:
- http://localhost:8080/metrics
- http://localhost:8080/health
    
I've implemented all the stories. Also added support for some extra currencies.
